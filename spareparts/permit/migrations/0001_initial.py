...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Permit'
        db.create_table(u'permit_permit', (
        ...
        db.send_create_signal(u'permit', ['Permit'])

        # Adding model 'PermitItems'
        db.create_table(u'permit_permititems', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('permit_number', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['permit.Permit'])),
        ...
        db.send_create_signal(u'permit', ['PermitItems'])


    def backwards(self, orm):
        # Deleting model 'Permit'
        db.delete_table(u'permit_permit')

        # Deleting model 'PermitItems'
        db.delete_table(u'permit_permititems')
    ...
    models = {
        ...
        u'permit.permititems': {
            ...
            'permit_number': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['permit.Permit']"}),
            'quantity': ('django.db.models.fields.PositiveSmallIntegerField', [], {})
        }
    }

    complete_apps = ['permit']