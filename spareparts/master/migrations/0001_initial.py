...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'master_sparepartstypes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('spareparts_type', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
        ))
        db.send_create_signal(u'master', ['SparePartsTypes'])

        # Adding model 'MasterSpareParts'
        db.create_table(u'master_masterspareparts', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('spareparts_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['master.SparePartsTypes'], on_delete=models.PROTECT)),
        ...
        db.send_create_signal(u'master', ['MasterSpareParts'])

        # Adding model 'StockSpareParts'
        db.create_table(u'master_stockspareparts', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'master', ['StockSpareParts'])


    def backwards(self, orm):
        # Deleting model 'SparePartsTypes'
        db.delete_table(u'master_sparepartstypes')

        # Deleting model 'MasterSpareParts'
        db.delete_table(u'master_masterspareparts')

        # Deleting model 'StockSpareParts'
        db.delete_table(u'master_stockspareparts')
