...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'purchase_purchaseitems', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('purchase', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.Purchase'], on_delete=models.PROTECT)),
            ('master_spare_parts', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['master.MasterSpareParts'], on_delete=models.PROTECT)),
        ...
        db.create_table(u'purchase_purchaseitemsdelivery', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('purchase_items', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['purchase.PurchaseItems'], on_delete=models.PROTECT)),
        ...
        db.send_create_signal(u'purchase', ['PurchaseItemsDelivery'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'purchase_purchaseitemsdelivery')
    ...
    models = {
        ...
        u'purchase.purchaseitems': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'master_spare_parts': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['master.MasterSpareParts']", 'on_delete': 'models.PROTECT'}),
            'memo': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'purchase': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['purchase.Purchase']", 'on_delete': 'models.PROTECT'}),
        ...
        u'purchase.purchaseitemsdelivery': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'memo': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'purchase_items': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['purchase.PurchaseItems']", 'on_delete': 'models.PROTECT'})
        }
    }
